import { GetUsuarioByCorreoData, GetUsuarioByCorreoVariables, GetEstudianteByUsuarioInternalIdData, GetEstudianteByUsuarioInternalIdVariables, ListarEstudiantesData, CrearEstudianteData, CrearEstudianteVariables, ActualizarEstudianteData, ActualizarEstudianteVariables, ActualizarEstudianteSinCorreoData, ActualizarEstudianteSinCorreoVariables, ActualizarPasswordUsuarioData, ActualizarPasswordUsuarioVariables, EliminarEstudianteData, EliminarEstudianteVariables, ListInstructorsData, GetRolByNumeroData, GetRolByNumeroVariables, CreateInstructorData, CreateInstructorVariables, UpdateInstructorData, UpdateInstructorVariables, DeleteInstructorData, DeleteInstructorVariables, ListCursosData, BuscarCursoPorNombreData, BuscarCursoPorNombreVariables, CursosPorCategoriaData, CursosPorCategoriaVariables, CursosPorEstadoData, CursosPorEstadoVariables, CreateCursoData, CreateCursoVariables, UpdateCursoData, UpdateCursoVariables, DeleteCursoData, DeleteCursoVariables, ListHorariosData, BuscarHorarioPorCursoData, BuscarHorarioPorCursoVariables, HorariosPorDiaData, HorariosPorDiaVariables, HorariosPorEstadoData, HorariosPorEstadoVariables, ListInscripcionesActivasData, CreateHorarioData, CreateHorarioVariables, UpdateHorarioData, UpdateHorarioVariables, DeleteHorarioData, DeleteHorarioVariables, ActualizarCupoHorarioData, ActualizarCupoHorarioVariables, ListCursosEstadisticasData, ListHorariosEstadisticasData, ListHorariosPorEstadoData, ListHorariosPorEstadoVariables, ListInscripcionesData, ListInscripcionesPorEstadoData, ListInscripcionesPorEstadoVariables, ListAsistenciasData, ListAsistenciasPorEstadoData, ListAsistenciasPorEstadoVariables, ListReportesEstadisticasData, ListReportesPorPeriodoData, ListReportesPorPeriodoVariables, ListReportesPorCursoData, ListReportesPorCursoVariables, GetCursoInternalIdData, GetCursoInternalIdVariables, CreateReporteEstadisticaData, CreateReporteEstadisticaVariables, UpdateReporteEstadisticaData, UpdateReporteEstadisticaVariables, GetInscripcionesByEstudianteData, GetInscripcionesByEstudianteVariables, GetInscripcionesByEstudianteIdData, GetInscripcionesByEstudianteIdVariables, GetHorariosDisponiblesData, InsscribirEstudianteData, InsscribirEstudianteVariables, CancelarInscripcionData, CancelarInscripcionVariables, TeacherGetInstructorByCorreoData, TeacherGetInstructorByCorreoVariables, TeacherListCursosPorCorreoData, TeacherListCursosPorCorreoVariables, TeacherListHorariosPorCursoData, TeacherListHorariosPorCursoVariables, TeacherListEstudiantesPorHorarioData, TeacherListEstudiantesPorHorarioVariables, TeacherListAsistenciasPorCorreoData, TeacherListAsistenciasPorCorreoVariables, TeacherCreateAsistenciaData, TeacherCreateAsistenciaVariables, TeacherUpdateAsistenciaData, TeacherUpdateAsistenciaVariables, TeacherDeleteAsistenciaData, TeacherDeleteAsistenciaVariables } from '../';
...
export function useGetEstudianteByUsuarioInternalId(vars: GetEstudianteByUsuarioInternalIdVariables, options?: useDataConnectQueryOptions<GetEstudianteByUsuarioInternalIdData>): UseDataConnectQueryResult<GetEstudianteByUsuarioInternalIdData, GetEstudianteByUsuarioInternalIdVariables>;
export function useGetEstudianteByUsuarioInternalId(dc: DataConnect, vars: GetEstudianteByUsuarioInternalIdVariables, options?: useDataConnectQueryOptions<GetEstudianteByUsuarioInternalIdData>): UseDataConnectQueryResult<GetEstudianteByUsuarioInternalIdData, GetEstudianteByUsuarioInternalIdVariables>;
...
export function useActualizarCupoHorario(options?: useDataConnectMutationOptions<ActualizarCupoHorarioData, FirebaseError, ActualizarCupoHorarioVariables>): UseDataConnectMutationResult<ActualizarCupoHorarioData, ActualizarCupoHorarioVariables>;
export function useActualizarCupoHorario(dc: DataConnect, options?: useDataConnectMutationOptions<ActualizarCupoHorarioData, FirebaseError, ActualizarCupoHorarioVariables>): UseDataConnectMutationResult<ActualizarCupoHorarioData, ActualizarCupoHorarioVariables>;
...
export function useGetInscripcionesByEstudianteId(vars: GetInscripcionesByEstudianteIdVariables, options?: useDataConnectQueryOptions<GetInscripcionesByEstudianteIdData>): UseDataConnectQueryResult<GetInscripcionesByEstudianteIdData, GetInscripcionesByEstudianteIdVariables>;
export function useGetInscripcionesByEstudianteId(dc: DataConnect, vars: GetInscripcionesByEstudianteIdVariables, options?: useDataConnectQueryOptions<GetInscripcionesByEstudianteIdData>): UseDataConnectQueryResult<GetInscripcionesByEstudianteIdData, GetInscripcionesByEstudianteIdVariables>;
...
export function useTeacherGetInstructorByCorreo(vars: TeacherGetInstructorByCorreoVariables, options?: useDataConnectQueryOptions<TeacherGetInstructorByCorreoData>): UseDataConnectQueryResult<TeacherGetInstructorByCorreoData, TeacherGetInstructorByCorreoVariables>;
export function useTeacherGetInstructorByCorreo(dc: DataConnect, vars: TeacherGetInstructorByCorreoVariables, options?: useDataConnectQueryOptions<TeacherGetInstructorByCorreoData>): UseDataConnectQueryResult<TeacherGetInstructorByCorreoData, TeacherGetInstructorByCorreoVariables>;

export function useTeacherListCursosPorCorreo(vars: TeacherListCursosPorCorreoVariables, options?: useDataConnectQueryOptions<TeacherListCursosPorCorreoData>): UseDataConnectQueryResult<TeacherListCursosPorCorreoData, TeacherListCursosPorCorreoVariables>;
export function useTeacherListCursosPorCorreo(dc: DataConnect, vars: TeacherListCursosPorCorreoVariables, options?: useDataConnectQueryOptions<TeacherListCursosPorCorreoData>): UseDataConnectQueryResult<TeacherListCursosPorCorreoData, TeacherListCursosPorCorreoVariables>;

export function useTeacherListHorariosPorCurso(vars: TeacherListHorariosPorCursoVariables, options?: useDataConnectQueryOptions<TeacherListHorariosPorCursoData>): UseDataConnectQueryResult<TeacherListHorariosPorCursoData, TeacherListHorariosPorCursoVariables>;
export function useTeacherListHorariosPorCurso(dc: DataConnect, vars: TeacherListHorariosPorCursoVariables, options?: useDataConnectQueryOptions<TeacherListHorariosPorCursoData>): UseDataConnectQueryResult<TeacherListHorariosPorCursoData, TeacherListHorariosPorCursoVariables>;

export function useTeacherListEstudiantesPorHorario(vars: TeacherListEstudiantesPorHorarioVariables, options?: useDataConnectQueryOptions<TeacherListEstudiantesPorHorarioData>): UseDataConnectQueryResult<TeacherListEstudiantesPorHorarioData, TeacherListEstudiantesPorHorarioVariables>;
export function useTeacherListEstudiantesPorHorario(dc: DataConnect, vars: TeacherListEstudiantesPorHorarioVariables, options?: useDataConnectQueryOptions<TeacherListEstudiantesPorHorarioData>): UseDataConnectQueryResult<TeacherListEstudiantesPorHorarioData, TeacherListEstudiantesPorHorarioVariables>;

export function useTeacherListAsistenciasPorCorreo(vars: TeacherListAsistenciasPorCorreoVariables, options?: useDataConnectQueryOptions<TeacherListAsistenciasPorCorreoData>): UseDataConnectQueryResult<TeacherListAsistenciasPorCorreoData, TeacherListAsistenciasPorCorreoVariables>;
export function useTeacherListAsistenciasPorCorreo(dc: DataConnect, vars: TeacherListAsistenciasPorCorreoVariables, options?: useDataConnectQueryOptions<TeacherListAsistenciasPorCorreoData>): UseDataConnectQueryResult<TeacherListAsistenciasPorCorreoData, TeacherListAsistenciasPorCorreoVariables>;

export function useTeacherCreateAsistencia(options?: useDataConnectMutationOptions<TeacherCreateAsistenciaData, FirebaseError, TeacherCreateAsistenciaVariables>): UseDataConnectMutationResult<TeacherCreateAsistenciaData, TeacherCreateAsistenciaVariables>;
export function useTeacherCreateAsistencia(dc: DataConnect, options?: useDataConnectMutationOptions<TeacherCreateAsistenciaData, FirebaseError, TeacherCreateAsistenciaVariables>): UseDataConnectMutationResult<TeacherCreateAsistenciaData, TeacherCreateAsistenciaVariables>;

export function useTeacherUpdateAsistencia(options?: useDataConnectMutationOptions<TeacherUpdateAsistenciaData, FirebaseError, TeacherUpdateAsistenciaVariables>): UseDataConnectMutationResult<TeacherUpdateAsistenciaData, TeacherUpdateAsistenciaVariables>;
export function useTeacherUpdateAsistencia(dc: DataConnect, options?: useDataConnectMutationOptions<TeacherUpdateAsistenciaData, FirebaseError, TeacherUpdateAsistenciaVariables>): UseDataConnectMutationResult<TeacherUpdateAsistenciaData, TeacherUpdateAsistenciaVariables>;

export function useTeacherDeleteAsistencia(options?: useDataConnectMutationOptions<TeacherDeleteAsistenciaData, FirebaseError, TeacherDeleteAsistenciaVariables>): UseDataConnectMutationResult<TeacherDeleteAsistenciaData, TeacherDeleteAsistenciaVariables>;
export function useTeacherDeleteAsistencia(dc: DataConnect, options?: useDataConnectMutationOptions<TeacherDeleteAsistenciaData, FirebaseError, TeacherDeleteAsistenciaVariables>): UseDataConnectMutationResult<TeacherDeleteAsistenciaData, TeacherDeleteAsistenciaVariables>;
